...
public class Render_old extends JComponent{
...
*/	// creates colarge, captures co-ordinates and stores in db
	...
	// Set Background Color of Colarge   
	    ...
	    try {
			ImageIO.write(finalImg, "png", new File("C:/Eclipse Workspace/Java/IEEE2014/Captcha/WebContent/img/finalImg.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}  
	...
	public Render_old() throws IOException{
		
		  resize();
		  
		  backImage = ImageIO.read(new File("C:/Eclipse Workspace/Java/IEEE2014/Captcha/images/resize.png"));
    	  backImage1 = ImageIO.read(new File("C:/Eclipse Workspace/Java/IEEE2014/Captcha/images/resize1.png"));
    	   
    	  frontImage = ImageIO.read(new File("C:/Eclipse Workspace/Java/IEEE2014/Captcha/images/resize2.png"));
          frontImage1 = ImageIO.read(new File("C:/Eclipse Workspace/Java/IEEE2014/Captcha/images/resize3.png"));
